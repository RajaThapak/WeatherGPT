...
import { Menu, Bell, MapPin, Search, Sun, Moon, History, ChevronRight, ArrowLeft, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 px-2 py-1">
      <div className="relative shrink-0" ref={menuRef}>
        ...
        {menuOpen && (
          <div className="absolute left-0 top-12 z-10 w-64 max-w-[calc(100vw-1rem)] overflow-hidden rounded-lg bg-surface-1 py-1 shadow-[0_12px_24px_rgba(0,0,0,0.30)]">
            {!historyOpen ? (
              <button
                type="button"
      ...
      <div className="relative shrink-0" ref={notifRef}>
        ...
        {notifOpen && (
          <div className="absolute left-0 top-12 z-10 w-72 max-w-[calc(100vw-1rem)] overflow-hidden rounded-lg bg-surface-1 py-1 shadow-[0_12px_24px_rgba(0,0,0,0.30)]">
      ...
      <div className="relative order-3 flex w-full justify-center px-0 sm:order-none sm:w-auto sm:flex-1 sm:px-4">
        ...
        {(results.length > 0 || searching) && (
          <ul className="absolute top-11 w-full max-w-sm overflow-y-auto rounded-lg bg-surface-1 p-1 shadow-[0_12px_24px_rgba(0,0,0,0.30)]">
